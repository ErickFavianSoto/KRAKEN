...
<?php
include("../modelo/buscadorConsolaUsuario.php");
...
public function busqueConsola($consola,$conec){


         $mysqli = new mysqli('db746642552.db.1and1.com','dbo746642552','0269ACmk.','db746642552');

         $sqls="SELECT * FROM consolas WHERE nomConsola like '$consola'";
         $nombrecategoria=$mysqli ->query($sqls);
         $arreglocategoria= mysqli_fetch_array($nombrecategoria);
         $valor=$arreglocategoria[0];


       $sql=("SELECT * FROM videojuegos_usuario WHERE idConsola like '$valor'");
